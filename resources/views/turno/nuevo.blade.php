    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form>
          ...
          <div class="row mb-3">
            <div class="input-group">
              <label class="input-group-text" for="veterinario_id">Profesional</label>
              <select class="form-select" id="veterinario_id">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <textarea id="basic-icon-default-message" class="form-control" placeholder="Escribe el mensaje que leerá el médico al momento de recibir tu turno de visita" aria-label="Escribe el mensaje que leerá el médico al momento de recibir tu turno de visita" aria-describedby="basic-icon-default-message2"></textarea>
              </div>
            </div>
          </div>
