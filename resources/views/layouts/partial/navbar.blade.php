  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="#" class="nav-link px-2 text-white">Contacenos</a></li>
        <li><a href="#" class="nav-link px-2 text-white">Veterinaria</a></li>
      </ul>
      ...
      @auth
        {{auth()->user()->name}}
        <div class="text-end">
          <a href="{{ route('logout.perform') }}" class="btn btn-outline-light me-2">Salida</a>
        </div>
      @endauth
      ...
      @guest
        <div class="text-end">
          ...
          <a href="{{ route('register.perform') }}" class="btn btn-warning">Registro</a>
        </div>
      @endguest
    </div>
  </div>
